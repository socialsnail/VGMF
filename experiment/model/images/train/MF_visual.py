...
class MatrixFactorization(BaseRecommendationModel):
    ...
    def residual_compute(self):
        ...
        m = self.mask_matrix + self.visual_similarity
    ...
    def als_update(self):
        ...
        residual = self.mask_matrix * (self.dataset.check_ins_matrix
    ...
    def set_dataset(self, dataset):
        ...
        print('k:', self.k, 'learning_rate:', self.eta, 'lambda:', self.lambda_,
              'kesai:', self.kesai,)
...
if __name__ == '__main__':
    ...
    mf = MatrixFactorization(k=10, learning_rate=0.01,
                             lambda_=1, kesai=0.2,
                             max_epoch=37, negative_rate=0.002,
                             geo_rate=0.01)
    # epoch 46
    mf.set_dataset(data)
